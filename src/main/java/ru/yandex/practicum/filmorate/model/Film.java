...
import static ru.yandex.practicum.filmorate.constant.Constants.FILM_RELEASE_DATE_LIMIT;
...
public class Film {
    ...
    @Length(max = Constants.MAX_DESCRIPTION_LENGTH, message = "Превышена максимальная длина описания")
